...
('Excellente bière', 4.8, 6, 1),
('Très bonne', 4.5, 5, 1),
('Ça passe', 3, 4, 1),
('Bière de clodo, ça peux aller en fin de soirée', 2, 2, 1),
('Bière forte, assez particulière', 3.5, 3, 1),
('Bière sympathique !', 4, 7, 1),
('fruitée et légèrement amère, très bonne!', 4, 13, 2),
('Un gout de café alcoolisé, pas très bonne sur le long terme. Très concentrée et forte en gout, a ne pas mettre entre toutes les mains.', 2, 13, 2),
('excellente découverte', 5, 20, 2),
('Ressemble a la delirium tremens. Très fort et très prononcée.', 4, 30, 2),
('Bel hommage au sud-ouest, très très bonne.', 5, 8, 2),
('Originale et à très bon goût.', 4, 26, 2),
('Bonne note d''amertume, léger gout d''agrume.', 4.2, 14, 3),
('Fruitée, saveur de mangue et de fruits de la passion.', 4.6, 15, 3),
('Très pétillante, florale et houblonnée', 4.4, 17, 3),
('Légère et douce, se savoure bien fraiche', 3.9, 27, 3);
